...
const api = axios.create({
  baseURL: process.env.REACT_APP_API_URL || 'https://alquilalo-backend.onrender.com/api',
  headers: {
...
export const getFeaturedItems = async () => {
  try {
    ...
    throw new Error(error.response?.data?.message || 'Error al obtener los items destacados');
  }
};
