...
const contactImage = 'https://images.unsplash.com/photo-1534536282195-9d973a734722?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80';
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('Hubo un error al enviar el mensaje. Por favor, intente nuevamente.');
    } finally {
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-blue-200">contacto@alquilalo.com</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <svg className="w-5 h-5 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-blue-200">Av. Principal 123, Ciudad, País</p>
                        </div>
                      </div>
                    </div>
                  </div>
